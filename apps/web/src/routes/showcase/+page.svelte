...
<script lang="ts">
  ...
  const demoVehicles: Vehicle[] = [
    ...
    { kind: 'reconciled', id: 'v-reconciled-1', route: route35, type: 'bus',
      ...
      confidence: 'medium',
      liveSources: ['gtfs-rt'] },
    { kind: 'corroborated', id: 'v-corroborated-1', route: route24, type: 'tram',
    ...
    { kind: 'predicted', id: 'v-predicted-1', route: route9, type: 'trolleybus',

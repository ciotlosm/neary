...
export const DEBUG_CONFIG = {
  // Debug line styles
  DISTANCE_LINE_COLOR: '#E91E63',
  PROJECTION_LINE_COLOR: '#9C27B0',
  ROUTE_SHAPE_COLOR: '#607D8B',
  
  // Debug marker styles
  VEHICLE_DEBUG_COLOR: '#FF5722',
  STATION_DEBUG_COLOR: '#3F51B5',
  PROJECTION_DEBUG_COLOR: '#795548',
